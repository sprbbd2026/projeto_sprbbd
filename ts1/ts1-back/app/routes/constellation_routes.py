...
@router.post("/register", response_model=ConstellationDetailResponse, status_code=201)
...
@router.get("/{con_id}", response_model=ConstellationDetailResponse)
...
@router.put("/update/{con_id}", response_model=ConstellationDetailResponse)
